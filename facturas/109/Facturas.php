...
//   $printer->text($data['empresa_nombre']);
  ...
  $printer->text("Barrio Las Flores 4ta calle Pte.(calle las parejas)");
  $printer->feed();

  $printer->text("entre 3ra y 5ta av. sur, Metapan, Santa Ana");
  $printer->feed();
  $printer->text("TELEFONO: 7879-4994" . $data['empresa_telefono']);
