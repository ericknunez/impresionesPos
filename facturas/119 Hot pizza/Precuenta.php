...
public function PrecuentaPrint($data, $printer){
    ...
    $img  = "C:/laragon/www/impresiones/facturas/119/img/logo.png";
   ...
   $printer -> setFont(Printer::FONT_A);
    ...
    $printer -> setLineSpacing(80);
    $printer->feed();
    $printer->text("Dirección: 6ta Calle Oriente entre 5ta y 7ma ");
    $printer->feed();
  
    $printer->text("Av, Norte N° 26 Chalchuapa, Santa Ana");
    $printer->feed();
    $printer->text("TELEFONO: 6056-7968");
  $printer->feed();
